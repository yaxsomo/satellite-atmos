...
//Make sure you set #define hspi2 as some hspix in main.h
...
#define FCLK_SLOW() { MODIFY_REG(hspi2.Instance->CR1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_128); }	/* Set SCLK = slow, approx 656 KBits/s*/
#define FCLK_FAST() { MODIFY_REG(hspi2.Instance->CR1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_2); }	/* Set SCLK = fast, approx 42 MBits/s */
